namespace SumOfCoins.Tests
{
    ...
    public class SumOfCoinsTests
    {
        ...
        public void TestWithProvidedExample()
        {
            ...
            expectedResult.Add(50, 18);
            expectedResult.Add(20, 1);
        ...
        public void TestWithLargeSum()
        {
            ...
            var expectedResult = new Dictionary<int, int>();
            expectedResult.Add(5, 406230824);
            expectedResult.Add(2, 1);
            expectedResult.Add(1, 1);
        ...
        public void TestWithNonOptimalParameters()
        {
            ...
            var expectedResult = new Dictionary<int, int>();
            expectedResult.Add(10, 2);
            expectedResult.Add(1, 7);
        ...
        public void TestWithOneCoinNeededOfEachValue()
        {
            ...
            var expectedResult = new Dictionary<int, int>();
            expectedResult.Add(1000, 1);
            expectedResult.Add(200, 1);
            expectedResult.Add(30, 1);
            expectedResult.Add(4, 1);
