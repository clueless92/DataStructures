...
namespace Dijkstra
{
    ...
    public class DijkstraMain
    {
        public static void Main()
        {
            ...
            //  6 { 10,  0,  0,  0, 17,  6,  0,  0,  0,  0,  0,  0 }, 
            //  7 {  0, 26, 15,  0,  0,  0,  0,  0,  0,  3,  0, 20 }, 
            //  8 { 12,  0, 14,  0,  0,  3,  0,  0,  0,  0,  0,  0 }, 
            ...
            Dictionary<int,Node> nodes, int sourceNode, int destinationNode)
        {
            ...
            var path = DijkstraWithPriorityQueue.
                DijkstraAlgorithm(graph, nodes[sourceNode], nodes[destinationNode]);
            if (path == null)
            {
            ...
            else
            {
                ...
                Console.WriteLine("{0} (length {1})",
                    formattedPath, nodes[destinationNode].DistanceFromStart);
            }
        }
    }
}
